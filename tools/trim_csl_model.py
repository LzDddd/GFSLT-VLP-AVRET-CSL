...
# data
raw_data = load_dataset_file('data/csldaily_data_label.train')
...
print(bos_index, pad_index,eos_index, unk_index)
...
tt.make_tokenizer()
print(tt.trimmed_vocab)
print(tt.trimmed_vocab_ids)
...
new_tokenizer.save_pretrained('pretrain_models/csl_mbart_char')
new_model.save_pretrained('pretrain_models/csl_mbart_char')

# mytran_model
configuration = MBartConfig.from_pretrained('pretrain_models/csl_mbart_char_my/config.json')
...
mytran_model.save_pretrained('pretrain_models/csl_mbart_char_my/')
